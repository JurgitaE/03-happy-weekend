...
Site published at: https://jurgitae.github.io/03-happy-weekend/
...
- CSS [selektoriai](https://www.w3schools.com/csSref/css_selectors.php)
...
1. Clone the repo
   ```sh
   git clone https://github.com/JurgitaE/03-happy-weekend.git
   ```
